 ...
 * 智能pos查询响应
 */
public class ReverseQueryRespMsgBody extends AbstractTranRespMsgBody {
    ...
    @JSONField(name = "OldRefundOrderNo")
    private String oldRefundOrderNo;

    public ReverseQueryRespMsgBody() {
    }
    ...
    public String getOldRefundOrderNo() {
        return oldRefundOrderNo;
    }

    public void setOldRefundOrderNo(String oldRefundOrderNo) {
        this.oldRefundOrderNo = oldRefundOrderNo;
    }
    ...
    public boolean equals(Object o) {
        ...
        ReverseQueryRespMsgBody that = (ReverseQueryRespMsgBody) o;
        return Objects.equals(oldPayType, that.oldPayType) &&
                ...
                Objects.equals(oldRefundOrderNo, that.oldRefundOrderNo);
    }

    @Override
    public int hashCode() {
        return Objects.hash(super.hashCode(), oldPayType, oldTranId, oldPayLs, oldTranAmt, oldCcyCode, oldBankDate, oldBankTime, oldTradeId, oldTradeNo, oldPayVounum, oldPayNo, oldTraceNo, oldOrderNo, oldRespCode, oldRespMsg, oldRefundOrderNo);
    }

    @Override
    public String toString() {
        return "ReverseQueryRespMsgBody{" +
                ...
                ", oldRefundOrderNo='" + oldRefundOrderNo + '\'' +
                "} " + super.toString();
    }
}
